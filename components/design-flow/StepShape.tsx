...
const SHAPES: { value: Shape; label: string; desc: string; path: string }[] = [
  { value: 'rectangle', label: 'Rectangle', desc: 'Classic ranch layout', path: 'M10,20 L90,20 L90,70 L10,70 Z' },
  { value: 'l-shape', label: 'L-Shape', desc: 'Extends with a wing', path: 'M10,20 L90,20 L90,50 L55,50 L55,80 L10,80 Z' },
  { value: 't-shape', label: 'T-Shape', desc: 'Central entry with wings', path: 'M30,15 L70,15 L70,45 L90,45 L90,80 L10,80 L10,45 L30,45 Z' },
  { value: 'u-shape', label: 'U-Shape', desc: 'Courtyard-facing design', path: 'M10,15 L90,15 L90,80 L65,80 L65,45 L35,45 L35,80 L10,80 Z' },
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {SHAPES.map(s => (
          <button key={s.value} onClick={() => onChange(s.value)}
            ...
            <svg viewBox="0 0 100 100" className="w-full h-16 mb-2">
