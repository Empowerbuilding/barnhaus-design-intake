...
type Props = { sqft?: number; bedrooms?: number; bathrooms?: number; onChange: (p: Partial<DesignState>) => void }

export default function StepSize({ sqft, bedrooms, bathrooms, onChange }: Props) {
  return (
    <div>
